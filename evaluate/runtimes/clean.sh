#!/usr/bin/env bash
#
# clean.sh — Reset the cluster to a known-good state for the Evaluate Runtimes exercise.
#
...
# setup.sh can be run cleanly afterwards.
#
# What it reverses:
#   1. The exercise namespace 'evaluate-runtimes' and everything in it
#      (InferenceServices, ServingRuntime, and any other resources students
...
echo ""
echo -e "${BOLD}Evaluate Runtimes Exercise — Clean / Reset${NC}"
